...
tended: 2026-07-23T13:16:47+08:00
---
Up until adding this particular scrolling banner to my homepage, I had no clue there was an HTML tag for the specific element: `<marquee>`. This might give my age away a little, but I learned it was first introduced in early versions of Internet Explorer and phased out as early as 1996.
...
```
2. **Legibility and control.** Chances are, whatever scroll speed I set is either too fast or too slow depending on reading speed. To grant some measure of control back, I added a line of CSS that pauses the animation on-hover. 
```js
...
While I'm okay with my implementation of a marquee that's passably functional, the argument against typical usage is sound. My intent in writing this down is to put my thought process and workarounds into words. Otherwise, it all tends to slip into a void of [[design decisions]] I can't quite articulate. This also keeps my door open to other options should I end up weighing it in my head more over time.