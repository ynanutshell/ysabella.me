...
When it comes to supporting software I do use and enjoy, my preference leans towards: one-time purchases, flexible donations, and regional/accessible pricing. Ultimately, having multiple ways to support makes *being* able to support easier.
...
I’ve installed a few small community plugins, mostly to keep my writing experience clean and intuitive. A running list of my current plugin setup:
<div class="row start wrap">
	<div class="card column lg vertical stretch">
		<div class="datapoint">
...
#### rsync script.
Eventually, I landed on setting up an `rsync` script that syncs all relevant files from my vault and ignores the rest, like templates and plugins.
```json
...
```
It’s hacky and not the most convenient method. It also means I can’t push content changes directly from my phone. But it does the job reliably and I’m usually wrapping up any writing on my computer anyway, because of styling I have to account for along the way.

### Custom properties and templates.
My properties are pretty standard compared to similar Obsidian publishing setups, but I do have templates for two different content types I have set up: writing and bookmarks.
#### Writing
