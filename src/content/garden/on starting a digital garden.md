...
## Some Inspiration
Over time, I’ll try to add to this list as I deep dive further into the rabbit hole of digital gardening (and the [IndieWeb](https://indieweb.org/) as a whole), with so many different and unique takes. Here are just a few that have pushed me to start my own and inspired my approach:
...
> 
> I wouldn’t worry too much over tooling, but there is a common sentiment that your digital garden should be something you own and have full control over, your own little slice of the internet, away from paywalls and platform obsolescence.